...
bio: My research interests are development and environmental economics. I am currently focusing on the drivers of deforestation in sub-Saharan Africa, on using remote sensing to estimate the economic cost of conflicts, and on natural resource management under regime shifts. Additionally, I work on stochastic processes and probability theory. Also a concert pianist.
...
My current research studies the drivers of deforestation, with a focus on Sub-Saharan Africa, the economic impact of conflicts using remote sensing techniques and natural resource management under the threat of regime shifts and natural catastrophes. Additionally, I work on probability theory and stochastic analysis, with a focus on nonlinear diffusion processes. I am a classical pianist, performing internationally. My Erdös number is 4. 
