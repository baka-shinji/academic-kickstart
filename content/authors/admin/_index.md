...
- icon: envelope
  icon_pack: fas
  link: 'mailto:daniele.rinaldo@graduateinstitute.ch'  # For a direct email link, use "mailto:test@example.org".
# - icon: twitter
#  icon_pack: fab
...
I am a postdoctoral researcher at The Graduate Institute, Geneva
